package openmart.apiserver.configuration;
...
public class SwaggerConfig implements WebMvcConfigurer {
	...
	public Docket api() {
		...
		Predicate<RequestHandler> basePackage = RequestHandlerSelectors.basePackage("openmart.apiserver.api.controller");
	...
	private ApiInfo apiInfo() {
		...
		String title = "OPEN-MART-API Documents";
